...
MutationType = GraphQLObjectType(
    ...
    fields={
        'executeAction': GraphQLField(
            ...
            description='SDN API actions made into an IP',
            args={
        ...
        'setupSchema': GraphQLField(
            ...
            description='API Server actions, used to connect with SDN Web services',
            args={
                'sdn_api': GraphQLArgument(
                    type=GraphQLString,
                    description='Where should SDN will connect'
                ) 
            },
            resolver=lambda root, args, *_: SDN.setup_connect(sdn_api=args.get('sdn_api', ''))
        )
    }
)
